...
function addCards(cardLink, cardName) {
    ...
    itemTemplate.querySelector(".card__images").addEventListener("click", function (evt) {
        popupImage.src = evt.target.src;
        popupText.textContent = evt.target.closest(".card").querySelector(".card__title").textContent;
        togglePopup(popupImage.parentNode.parentNode);
    });
    itemTemplate.querySelector(".card__trash").addEventListener("click", function (evt) {
        evt.target.parentElement.remove();
    });
    itemTemplate.querySelector(".card__like").addEventListener("click", function (evt) {
...
closeBtnImg.addEventListener("click", function () {
    document.querySelector(".popup__container_image").classList.remove("popup_opened");
});
